...
To test the mathematical model we are using two models with single dataset [\citenum{parkinsons_disease_detection}]. The said dataset contains 201 records of with total of 754 feature each row. The models used for the testing are random forest and support vector machine algorithm, which will be denoted as M$_1$ and M$_2$ respectively. These models and dataset is fed into the following tests cases.
